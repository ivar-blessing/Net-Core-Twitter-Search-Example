...
$(document).ready(function () {
    ...
    var headerHTML = '';
    var loadingHTML = '';
    headerHTML += '<div id="twitter-header"><a href="https://twitter.com/" target="_blank"><img src="images/twitter-bird-light.png" style="float:left;padding:3px 12px 0px 6px" alt="twitter bird" /></a>';
